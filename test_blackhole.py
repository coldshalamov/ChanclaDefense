...
# We already ran this script previously and it injected the strings.
# Wait! Since I ran it before, `isBlackhole` and `GALAXY BURST` are already in the file.
# Did I run it? Yes, let me check.
